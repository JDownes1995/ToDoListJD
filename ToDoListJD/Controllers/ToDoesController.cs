...
namespace ToDoListJD.Controllers
{
    public class ToDoesController : Controller
    {
        ...
        // GET: ToDoes
        // Authorize means user needs to log in to perform the Index() action
        // Will show user a login screen
        [Authorize]
        ...
        private IEnumerable<ToDo> GetMyToDoes()
        {
            ...
            ViewBag.Percent = Math.Round(100f * ((float)completeCount / myToDoes.Count()));
